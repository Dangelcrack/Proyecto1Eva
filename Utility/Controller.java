...
public class Controller {
    ...
    public static void initializeGame(String string) {
        // Crear una baraja (puedes elegir entre baraja francesa, española u otros tipos)
        Desk desk = new Desk(string); // Ejemplo de creación de una baraja francesa, ajusta según tus necesidades
        game.setDesk(desk);
